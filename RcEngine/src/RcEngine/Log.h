...
#define RC_CORE_ERROR(...) ::RcEngine::Log::GetCoreLogger()->error(__VA_ARGS__)
...
#define RC_CORE_FATAL(...) ::RcEngine::Log::GetCoreLogger()->fatal(__VA_ARGS__)
...
#define RC_FATAL(...) ::RcEngine::Log::GetClientLogger()->fatal(__VA_ARGS__)